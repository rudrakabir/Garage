...
const DRUMS = [
  { key: 'Q', label: 'Kick', color: 'bg-blue-500', sound: '/audio/drums/kick.mp3' },
  { key: 'W', label: 'Snare', color: 'bg-red-500', sound: '/audio/drums/snare.mp3' },
  { key: 'E', label: 'Hi-Hat', color: 'bg-green-500', sound: '/audio/drums/hihat.mp3' },
  { key: 'A', label: 'Tom 1', color: 'bg-yellow-500', sound: '/audio/drums/tom1.mp3' },
  { key: 'S', label: 'Tom 2', color: 'bg-purple-500', sound: '/audio/drums/tom2.mp3' },
  { key: 'D', label: 'Crash', color: 'bg-pink-500', sound: '/audio/drums/crash.mp3' },
  { key: 'Z', label: 'Clap', color: 'bg-orange-500', sound: '/audio/drums/clap.mp3' },
  { key: 'X', label: 'Rim', color: 'bg-teal-500', sound: '/audio/drums/rim.mp3' },
  { key: 'C', label: 'Ride', color: 'bg-indigo-500', sound: '/audio/drums/ride.mp3' }
];
